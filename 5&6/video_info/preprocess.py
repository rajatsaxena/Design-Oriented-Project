# Frame skipping: will create a video that only one frame for each section of the original video.
# ROI extraction: which will create a video that only contains the specified region of interest.
...
#
# Extracts one frame for every second of video.
